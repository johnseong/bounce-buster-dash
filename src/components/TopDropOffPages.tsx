    ...
    <div className="asana-card overflow-hidden">
      ...
      <div>
        {dropOffPages.map((page) => (
          <div
            key={page.path}
            className="flex items-center justify-between px-5 py-3 border-t border-border hover:bg-muted/40 transition-colors cursor-pointer group"
          >
                ...
                <div className="flex-1 h-1.5 rounded-full bg-muted overflow-hidden">
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: page.bounceRate > 65
                        ? "hsl(var(--chart-alert))"
                        : page.bounceRate > 50
