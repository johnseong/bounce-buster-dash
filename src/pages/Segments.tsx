...
const segments = [
  { name: "Power Users", icon: Zap, count: 1240, bounce: "18%", avgSession: "8m 32s", color: "bg-accent text-accent-foreground" },
  { name: "Mobile Visitors", icon: Smartphone, count: 5680, bounce: "72%", avgSession: "0m 48s", color: "bg-chart-warning/10 text-chart-warning" },
  { name: "Desktop Users", icon: Monitor, count: 3420, bounce: "45%", avgSession: "3m 12s", color: "bg-chart-success/10 text-chart-success" },
  { name: "International", icon: Globe, count: 2150, bounce: "65%", avgSession: "1m 05s", color: "bg-primary/10 text-primary" },
  { name: "Returning Users", icon: Users, count: 890, bounce: "28%", avgSession: "5m 44s", color: "bg-accent text-accent-foreground" },
];
